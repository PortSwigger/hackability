window.Inspector = function(){
  ...
  result, domObjects, callbacks = {}, historyPos = 0, types = ['array','NaN','null','function','object','string','boolean','symbol','undefined','number','window','function constructor','object constructor','document','dom node','x-domain window','java bridge','location','x-domain location','dom collection'].sort();
