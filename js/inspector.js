window.inspector = function(){
  ...
  result, domObjects, historyPos = 0, types = ['array','nan','null','function','object','string','boolean','symbol','undefined','number','window','function constructor','document','dom node','x-domain window','java bridge'].sort();
